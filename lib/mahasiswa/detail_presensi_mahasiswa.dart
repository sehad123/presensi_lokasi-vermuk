...
class DetailPresensiMahasiswa extends StatelessWidget {
  final Map<String, dynamic> attendanceData;

  const DetailPresensiMahasiswa({Key? key, required this.attendanceData})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Detail Presensi Mahasiswa'),
      ),
      body: Padding(
